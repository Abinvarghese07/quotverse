...
const Likedpage = () => {
    ...
    const[likeData,setLikedData] = useState({})
 

    const likedData = async () => {
        const api = await fetch(`https://api.quotable.io/quotes/${params.id}`)
    ...
    return (
        <div className='mx-[7vh] flex  bg-zinc-900  '>
             <div className='text-white p-[40px] hidden lg:flex flex-col  font-inter border-r border-slate-800 w-[400px] '> 
            ...
            <div className='text-white p-2 font-inter border border-slate-800 w-[640px] mb-[15vh]'>
          <div className='text-start py-2 flex border-b-2 border-slate-800'>
            ...
            <div className='flex flex-col px-2 py-1 '>
                 <h1 className='text-[14px] font-medium'>{likeData.author}</h1>
            <h2 className=''>{likeData.content}</h2>
           ...
           <p className="text-[13px] font-thin mb-3">{likeData.tags}</p>
            </div>
               ...
               <div className={!isOpen ? 'hidden lg:flex text-white  text-start py-6 px-8 pl-12 font-inter  flex-col w-[400px]' : '  text-white  text-start  lg:py-8 lg:px-8 lg:pl-12 font-inter flex flex-col w-[200px] lg:w-[400px]'}>
                ...
                <h1 className='text-[11px]   lg:text-[20px] font-semibold py-2 px-3' >Trending Topics</h1>
                <IoSettingsOutline className='hidden lg:text-2xl text-slate-400'></IoSettingsOutline>
                </div>
